...
\]
and not an inclusion in either direction: Proposition~\ref{prop:T2} gives
PB-objects outside $\mathcal{I}$ (non-central radical, impossible in a
semisimple $C^*$-algebra), and Proposition~\ref{prop:chirality} gives
$C^*$-algebras outside the image (no real form at all).
