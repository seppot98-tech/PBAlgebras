...
Convention~\ref{conv:degenerate} there is no terminal object, and hence no
limits, for reasons unrelated to the subject.
\end{proposition}
...
Without the degenerate object, suppose $T$ were terminal and let
...
object, and since the terminal object is the empty product, no limits.
\end{proof}
